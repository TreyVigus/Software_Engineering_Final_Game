...
{ 
	...
	This code has been reworked from C into C# by Jeffrey Childs.  I take full responsibility
	for any errors introduced. -- Jeffrey Childs */ 
	
	class cGLShape 
	{
		private IntPtr quadObj; 
		
		public cGLShape() 
		{
            quadObj = Glu.NewQuadric();
		} 
